...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2025 at 12:42 AM
...
CREATE TABLE `accounting` (
  ...
  `webinar_id` int(10) UNSIGNED DEFAULT NULL,
  `bundle_id` int(10) UNSIGNED DEFAULT NULL,
  `event_ticket_id` int(10) UNSIGNED DEFAULT NULL,
  `meeting_time_id` int(10) UNSIGNED DEFAULT NULL,
  `meeting_package_id` int(10) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `advertising_banners` (
  `id` int(10) UNSIGNED NOT NULL,
  `position` enum('home1','home2','course','course_sidebar','product_show','bundle','bundle_sidebar','upcoming_course','upcoming_course_sidebar','event','event_sidebar') NOT NULL,
...
CREATE TABLE `become_instructors` (
  ...
  `description` text DEFAULT NULL,
  `status` enum('pending','accept','reject','pending_pay_package') NOT NULL DEFAULT 'pending',
  `created_at` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
(612, 'sample-category', NULL, '/store/1/default_images/categories_icons/anchor.png', 1, NULL, NULL, NULL, NULL, 1);
...
CREATE TABLE `discounts` (
  ...
  `source` enum('all','course','category','meeting','product','bundle','event','meeting_package') NOT NULL,
...
--
-- Table structure for table `discount_meeting_packages`
--
...
--
-- Table structure for table `event_filter_options`
--
...
--
-- Table structure for table `event_speaker_translations`
--
...
--
-- Table structure for table `event_tickets_sold`
--
...
--
-- Table structure for table `event_ticket_translations`
--
...
INSERT INTO `landings` (`id`, `url`, `preview_img`, `color_id`, `enable`, `created_at`) VALUES
(1, 'default', '/store/landing_builder/landing_1//preview_img.jpg', NULL, 1, 1748938121);
...
CREATE TABLE `meetings` (
  ...
  `enable_meeting_packages` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `meeting_packages`
--
...
--
-- Table structure for table `meeting_packages_sold`
--
...
--
-- Table structure for table `meeting_package_translations`
--
...
(625, '2025_08_09_163016_add_attendance_column_to_sessions_table', 281),
(626, '2025_08_10_131232_create_session_attendance_table', 281),
(627, '2025_08_12_153316_create_session_attendance_notifications_table', 281),
(628, '2025_08_16_123452_create_bulk_imports_table', 281),
(629, '2025_08_17_164435_add_column_auto_renew_subscription_to_users_table', 281),
(630, '2025_08_20_140438_create_subscribe_specification_items_table', 281),
(631, '2025_08_22_150458_add_only_for_students_column_to_webinars_table', 281),
(632, '2025_09_02_145610_create_events_table', 281),
(633, '2025_09_02_152043_create_event_filter_options_table', 281),
(634, '2025_09_02_154722_add_event_to_tags_table', 281),
(635, '2025_09_07_140951_create_event_tickets_table', 281),
(636, '2025_09_07_161717_create_event_speakers_table', 281),
(637, '2025_09_09_135608_add_event_to_prerequisites_table', 281),
(638, '2025_09_09_143233_add_event_to_faqs_table', 281),
(639, '2025_09_13_142116_add_event_to_webinar_extra_descriptions_table', 281),
(640, '2025_09_13_152844_create_specific_locations_table', 281),
(641, '2025_09_18_151202_add_event_ticket_to_orders_table', 281),
(642, '2025_09_19_143807_add_event_ticket_to_comments_table', 281),
(643, '2025_09_20_135317_create_event_reports_table', 281),
(644, '2025_09_20_141508_add_event_position_to_advertising_banners_table', 281),
(645, '2025_09_23_134124_add_event_to_cart_table', 281),
(646, '2025_09_24_150312_create_discount_events_table', 281),
(647, '2025_09_25_093850_create_event_tickets_sold_table', 281),
(648, '2025_09_28_000000_add_type_and_order_id_to_offline_payments_table', 281),
(649, '2025_09_28_151309_add_event_to_sessions_table', 281),
(650, '2025_09_28_164306_add_event_to_registration_packages_table', 281),
(651, '2025_09_30_000001_change_amount_type_in_offline_payments_table', 281),
(652, '2025_10_08_163406_add_color_to_landings_table', 281),
(653, '2025_10_11_150109_add_enable_meeting_packages_to_meetings_table', 281),
(654, '2025_10_12_104705_create_meeting_packages_table', 281),
(655, '2025_10_14_135557_add_meeting_package_to_orders_and_sales_table', 281),
(656, '2025_10_14_144432_add_meeting_package_to_discounts_table', 281),
(657, '2025_10_15_143113_create_meeting_packages_sold_table', 281),
(658, '2025_10_18_153215_add_meeting_packages_to_registration_packages_table', 281),
(659, '2025_10_18_153929_add_new_to_user_registration_packages_table', 281),
(660, '2025_11_01_142659_add_private_to_bundles_table', 281),
(661, '2025_11_03_143739_edit_video_demo_column_type', 281),
(662, '2025_11_04_150626_edit_varchar_to_text_column_type_in_users_table', 281),
(663, '2025_11_05_155429_add_enable_switch_to_categories_table', 281),
(664, '2025_11_16_132954_add_new_status_to_become_instructors_table', 281);
...
CREATE TABLE `offline_payments` (
  ...
  `type` enum('charge','cart') NOT NULL DEFAULT 'charge',
...
CREATE TABLE `registration_packages` (
  ...
  `meeting_packages_count` int(10) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `sales` (
  ...
  `type` enum('webinar','meeting','subscribe','promotion','registration_package','product','bundle','installment_payment','gift','event_ticket','meeting_package') NOT NULL,
...
(3190, 'admin_attendances', NULL, 'Attendances', 'admin'),
(3191, 'admin_attendances_history', 3190, 'History', 'admin'),
(3192, 'admin_attendances_history_details', 3190, 'History Details', 'admin'),
(3193, 'admin_attendances_settings', 3190, 'Settings', 'admin'),
(3200, 'admin_imports_from_csv', NULL, 'Imports From CSV', 'admin'),
(3201, 'admin_imports_from_csv_history', 3200, 'History', 'admin'),
(3202, 'admin_imports_from_csv_courses', 3200, 'Import Courses', 'admin'),
(3203, 'admin_imports_from_csv_categories', 3200, 'Import Categories', 'admin'),
(3204, 'admin_imports_from_csv_users', 3200, 'Import Users', 'admin'),
(3205, 'admin_imports_from_csv_products', 3200, 'Import Products', 'admin'),
(3210, 'admin_events', NULL, 'Events', 'admin'),
(3211, 'admin_events_create', 3210, 'Create/Edit', 'admin'),
(3212, 'admin_events_lists', 3210, 'Lists', 'admin'),
(3213, 'admin_events_delete', 3210, 'Delete', 'admin'),
(3214, 'admin_events_tickets', 3210, 'Tickets (Create/Edit/Delete)', 'admin'),
(3215, 'admin_events_speakers', 3210, 'Speakers (Create/Edit/Delete)', 'admin'),
(3216, 'admin_events_settings', 3210, 'Settings', 'admin'),
(3217, 'admin_events_lists_export_excel', 3210, 'Export Lists (excel)', 'admin'),
(3218, 'admin_events_sold_tickets', 3210, 'Event Sold Tickets', 'admin'),
(3219, 'admin_event_comments', 3210, 'Comments', 'admin'),
(3220, 'admin_event_send_notification', 3210, 'Send Notification To Event Students', 'admin'),
(3230, 'admin_meeting_packages', NULL, 'Meeting Packages', 'admin'),
(3231, 'admin_meeting_packages_create', 3230, 'Create/Edit', 'admin'),
(3232, 'admin_meeting_packages_lists', 3230, 'Lists', 'admin'),
(3233, 'admin_meeting_packages_delete', 3230, 'Delete', 'admin'),
(3234, 'admin_meeting_packages_sold', 3230, 'Sold Packages', 'admin'),
(3235, 'admin_meeting_packages_settings', 3230, 'Settings', 'admin'),
...
(100320, 'panel_attendances', NULL, 'Attendances', 'panel'),
(100321, 'panel_attendances_lists', 100320, 'Attendances lists', 'panel'),
(100330, 'panel_events', NULL, 'Events', 'panel'),
(100331, 'panel_events_create', 100330, 'create/edit', 'panel'),
(100332, 'panel_events_lists', 100330, 'Lists', 'panel'),
(100333, 'panel_events_sold_tickets_lists', 100330, 'Event Sold Tickets', 'panel'),
(100334, 'panel_events_organization_lists', 100330, 'Organization Events', 'panel'),
(100335, 'panel_events_my_purchases', 100330, 'My Purchases', 'panel'),
(100336, 'panel_events_my_comments', 100330, 'My Comments', 'panel'),
(100337, 'panel_events_comments', 100330, 'Comments', 'panel');
...
--
-- Table structure for table `session_attendance_notifications`
--
...
--
-- Table structure for table `specific_locations`
--
...
CREATE TABLE `subscribes` (
  `id` int(10) UNSIGNED NOT NULL,
  `target_type` enum('all','courses','bundles') NOT NULL DEFAULT 'all',
  `target` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `subscribe_specification_items`
--
...
CREATE TABLE `users` (
  ...
  `auto_renew_subscription` tinyint(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `user_commissions` (
  ...
  `source` enum('courses','bundles','virtual_products','physical_products','meetings','events','meeting_packages') NOT NULL,
...
(1, 1016, 1016, 612, 'course', 0, 'Sample-Course', NULL, 90, 'America/New_York', '/store/1016/1.jpg', '/store/1016/1_c.jpg', '/store/1016/Become A Product Manager.mp4', 'upload', NULL, NULL, NULL, 0.00, NULL, 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, 'active', 1656669428, 1656669564, NULL);
...
ALTER TABLE `cart`
  ...
  ADD KEY `cart_event_ticket_id_foreign` (`event_ticket_id`),
  ADD KEY `cart_meeting_package_id_foreign` (`meeting_package_id`);
...
ALTER TABLE `comments_reports`
  ...
  ADD KEY `comments_reports_event_id_foreign` (`event_id`);
...
--
-- Indexes for table `discount_meeting_packages`
--
...
--
-- Indexes for table `event_filter_options`
--
...
--
-- Indexes for table `event_speaker_translations`
--
...
--
-- Indexes for table `event_tickets_sold`
--
...
--
-- Indexes for table `event_ticket_translations`
--
...
ALTER TABLE `faqs`
  ...
  ADD KEY `faqs_event_id_foreign` (`event_id`);
...
ALTER TABLE `landings`
  ...
  ADD KEY `landings_color_id_foreign` (`color_id`);
...
--
-- Indexes for table `meeting_packages`
--
...
--
-- Indexes for table `meeting_packages_sold`
--
...
--
-- Indexes for table `meeting_package_translations`
--
...
ALTER TABLE `offline_payments`
  ...
  ADD KEY `offline_payments_order_id_foreign` (`order_id`);
...
ALTER TABLE `prerequisites`
  ...
  ADD KEY `prerequisites_event_id_foreign` (`event_id`);
...
--
-- Indexes for table `session_attendance_notifications`
--
...
--
-- Indexes for table `specific_locations`
--
...
--
-- Indexes for table `subscribe_specification_items`
--
...
ALTER TABLE `tags`
  ...
  ADD KEY `tags_event_id_foreign` (`event_id`);
...
ALTER TABLE `webinar_extra_descriptions`
  ...
  ADD KEY `webinar_extra_descriptions_event_id_foreign` (`event_id`);
...
ALTER TABLE `webinar_reviews`
  ...
  ADD KEY `webinar_reviews_event_id_foreign` (`event_id`);
...
--
-- AUTO_INCREMENT for table `discount_meeting_packages`
--
ALTER TABLE `discount_meeting_packages`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `event_filter_options`
--
ALTER TABLE `event_filter_options`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `event_speaker_translations`
--
ALTER TABLE `event_speaker_translations`
...
--
-- AUTO_INCREMENT for table `event_tickets_sold`
--
ALTER TABLE `event_tickets_sold`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `event_ticket_translations`
--
ALTER TABLE `event_ticket_translations`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `meeting_packages`
--
ALTER TABLE `meeting_packages`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `meeting_packages_sold`
--
ALTER TABLE `meeting_packages_sold`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `meeting_package_translations`
--
ALTER TABLE `meeting_package_translations`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `sections`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100338;
...
--
-- AUTO_INCREMENT for table `session_attendance_notifications`
--
ALTER TABLE `session_attendance_notifications`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `specific_locations`
--
ALTER TABLE `specific_locations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `subscribe_specification_items`
--
ALTER TABLE `subscribe_specification_items`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `cart_event_ticket_id_foreign` FOREIGN KEY (`event_ticket_id`) REFERENCES `event_tickets` (`id`) ON DELETE CASCADE,
  ...
  ADD CONSTRAINT `cart_meeting_package_id_foreign` FOREIGN KEY (`meeting_package_id`) REFERENCES `meeting_packages` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `comments_reports`
  ...
  ADD CONSTRAINT `comments_reports_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
...
--
-- Constraints for table `discount_events`
--
ALTER TABLE `discount_events`
  ADD CONSTRAINT `discount_events_discount_id_foreign` FOREIGN KEY (`discount_id`) REFERENCES `discounts` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `discount_events_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `discount_meeting_packages`
--
ALTER TABLE `discount_meeting_packages`
...
--
-- Constraints for table `event_filter_options`
--
ALTER TABLE `event_filter_options`
...
--
-- Constraints for table `event_speaker_translations`
--
ALTER TABLE `event_speaker_translations`
...
--
-- Constraints for table `event_ticket_translations`
--
ALTER TABLE `event_ticket_translations`
...
ALTER TABLE `faqs`
  ...
  ADD CONSTRAINT `faqs_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `landings`
  ADD CONSTRAINT `landings_color_id_foreign` FOREIGN KEY (`color_id`) REFERENCES `theme_colors_fonts` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `meeting_package_translations`
--
ALTER TABLE `meeting_package_translations`
...
ALTER TABLE `offline_payments`
  ...
  ADD CONSTRAINT `offline_payments_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE SET NULL,
...
ALTER TABLE `prerequisites`
  ...
  ADD CONSTRAINT `prerequisites_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
...
--
-- Constraints for table `session_attendance_notifications`
--
ALTER TABLE `session_attendance_notifications`
...
--
-- Constraints for table `specific_locations`
--
ALTER TABLE `specific_locations`
...
--
-- Constraints for table `subscribe_specification_items`
--
ALTER TABLE `subscribe_specification_items`
...
ALTER TABLE `tags`
  ...
  ADD CONSTRAINT `tags_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `webinar_extra_descriptions`
  ...
  ADD CONSTRAINT `webinar_extra_descriptions_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `webinar_reviews`
  ...
  ADD CONSTRAINT `webinar_reviews_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
